...
public class CalculatorAppProject extends WindowAdapter implements ActionListener {
    Frame f;
    Label l1;
    ...
    // MAIN METHOD WHERR OBJECTS OF Project1 is instantiated
    public static void main(String[] args) {
        new CalculatorAppProject();
    }
}
